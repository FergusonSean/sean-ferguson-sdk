...
interface FilterableRequestParams<
  FilterableFieldType extends (string | number | symbol) = string
...
export class Client {
  ...
  static generateQuery<FilterKeyType extends (string | number | symbol)>(
    params: FilterableRequestParams<FilterKeyType>
  ) {
